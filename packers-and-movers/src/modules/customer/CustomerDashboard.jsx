...
import {
    TextField, Button, Box, Avatar, Tabs, Tab,
    Card, IconButton, InputBase, Paper, Divider
} from '@mui/material';
import {
    PersonOutline, GroupOutlined, PhotoLibraryOutlined,
    Logout, Email, Language, Place, WorkOutline,
    Facebook, Twitter, PlayCircleOutline, Add,
        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-slate-50 p-4">
                <Box className="w-full max-w-md bg-white p-10 shadow-xl rounded-xl border border-gray-100"
                    sx={{ width: 400 }}>
                    <div className="text-center mb-4"> {/* Increased bottom margin here */}
                        <h2 className="text-3xl mt-0 font-bold text-gray-800">User Login</h2>
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <TextField
                            ...
                            sx={{ mt: 2, '& .MuiOutlinedInput-root.Mui-focused fieldset': { borderColor: '#7c3aed' } }}
                        />
                        <Button
                    ...
                    <div className="px-8 pb-6 relative">
                        <div className="flex flex-col md:flex-row items-center justify-between mt-[-40px]">
                            ...
                            <div className="flex items-center gap-3 mt-4 md:mt-15">
                                <IconButton size="small" className="bg-blue-600 text-white"><Facebook fontSize="small" /></IconButton>
                                <IconButton size="small" className="bg-sky-400 text-white"><Twitter fontSize="small" /></IconButton>
                                <IconButton size="small" className="bg-pink-500 text-white"><PlayCircleOutline fontSize="small" /></IconButton>
                                <Button variant="contained" className="bg-indigo-600 mt-5 rounded-lg normal-case ml-2" startIcon={<Add />}>
                                    Book a Move
                 </Button>
                            </div>
                        </div>
                    ...
                    <div className="md:col-span-1 space-y-6">
                        <Card className="p-6 rounded-2xl shadow-sm border-none">
                            ...
                            <div className="space-y-4 text-gray-600">
                                <div className="flex items-center gap-3 text-sm"><Email fontSize="small" /> {user.email}</div>
                    ...
                    <div className="md:col-span-2 space-y-6">
                        <Card className="p-4 rounded-2xl shadow-sm border-none">
                            ...
                            <div className="flex justify-between items-center">
                                <div className="flex gap-4">
                                    <Button size="small" startIcon={<PhotoLibraryOutlined color="primary" />} className="text-gray-600 normal-case">Photo / Video</Button>
                                </div>
                                <Button variant="contained" className="bg-indigo-600 shadow-none rounded-lg px-6">Submit</Button>
                            </div>
                        </Card>
                        ...
                        <Card className="p-6 rounded-2xl shadow-sm border-none">
                            ...
                            <p className="text-gray-700 text-sm mb-4">
                                Working on the new logistics flow today! Really excited to see how the status tracking helps our customers.
              </p>

    ...
    return (
        ...
        <div className="border-b border-black/20">
          <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              { icon: <LocationOn />, title: "Address:", value: "4578 Pune Road" },
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-4 gap-14">
          ...
          <div>
            ...
            We provide reliable and professional packing and moving services, ensuring safe, 
            timely, and hassle-free relocation for homes and businesses.
            </p>
          ...
          <div>
            ...
            <p className="text-sm text-black-1000 mb-6">
